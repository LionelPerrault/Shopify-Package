...
- 814a9c1: Bump @shopify/shopify-api from 6.2.0 to 7.0.0. See [changelog](https://github.com/LionelPerrault/Shopify-Package/shopify-api-js/blob/main/CHANGELOG.md) for details.

  ⚠️ [Breaking] Refer to the [6 to 7 migration guide](https://github.com/LionelPerrault/Shopify-Package/shopify-api-js/blob/main/docs/migrating-to-v7.md) for more details on how the `.api` property returned by `shopifyApp` may be impacted by this release of the API library.
