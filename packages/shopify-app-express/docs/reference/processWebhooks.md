...
Defines the webhooks your app will listen to, and how to handle them. See [the `@shopify/shopify-api` documentation](https://github.com/LionelPerrault/Shopify-Package/shopify-api-js/blob/main/docs/guides/webhooks.md) for the allowed values.
